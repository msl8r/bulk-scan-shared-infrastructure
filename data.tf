locals {
  ...
  app_aks_network_name = var.env ==  "aat" ? "cft-aat-vnet" : "core-${local.aks_env}-vnet"
  app_aks_network_rg_name =  var.env ==  "aat" ? "cft-aat-network-rg" : "aks-infra-${local.aks_env}-rg"
}
